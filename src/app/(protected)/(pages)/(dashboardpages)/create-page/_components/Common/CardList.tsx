...
const CardList = ({outlines,addMultipleOutlines,editText,editingCard,onCardDoubleClick,onCardSelect,onEditChange,selectedCard,setEditText,setEditingCard,setSelectedCard}:Props) => {
